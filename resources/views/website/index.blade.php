              ...
              <div class="col-12 col-xl-6 col-lg-6">
                  <div class="hero-items">
                      ...
                      <div class="book-image">
                          <img src="{{ asset('img/hero/hero-book.png') }}" alt="img">
                      </div>
                ...
                <div class="swiper book-slider">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="shop-box-items style-2">
                                <div class="book-thumb center">
                                    <a href="shop-details"><img src="{{ asset('img/book/01.png') }}" alt="img"></a>
                                    <ul class="post-box">
                                        <li>
                                            Hot
                                        </li>
                        ...
                        <div class="swiper-slide">
                            <div class="shop-box-items style-2">
                                <div class="book-thumb center">
                                    <a href="shop-details"><img src="{{ asset('img/book/04.png') }}" alt="img"></a>
                                    <ul class="post-box">
                                        <li>
                                            -12%
                                        </li>
            ...
            <div class="swiper featured-books-slider">
                  ...
                  <div class="swiper-slide">
                        <div class="shop-box-items style-4 wow fadeInUp" data-wow-delay=".2s">
                              <div class="book-thumb center">
                              <a href="shop-details"><img src="{{ asset('img/book/07.png') }}" alt="img"></a>
                              </div>
                              <div class="shop-content">
                  ...
                  <div class="swiper-slide">
                        <div class="shop-box-items style-4 wow fadeInUp" data-wow-delay=".2s">
                              <div class="book-thumb center">
                              <a href="shop-details"><img src="{{ asset('img/book/11.png') }}" alt="img"></a>
                              </div>
                              <div class="shop-content">
                              <ul class="book-category">
                                    <li class="book-category-badge">Adventure</li>
                  ...
                  <div class="swiper-slide">
                        <div class="shop-box-items style-4 wow fadeInUp" data-wow-delay=".2s">
                              <div class="book-thumb center">
                              <a href="shop-details"><img src="{{ asset('img/book/10.png') }}" alt="img"></a>
                              </div>
                              <div class="shop-content">
                              <ul class="book-category">
                                    <li class="book-category-badge">Adventure</li>
      ...
      <div class="container">
          ...
          <div class="book-shop-wrapper style-2">
              ...
              <div class="shop-box-items style-3 wow fadeInUp" data-wow-delay=".4s">
                  <div class="book-thumb center">
                      <a href="shop-details"><img src="{{ asset('img/book/08.png') }}" alt="img"></a>
                  </div>
                  <div class="shop-content">
                      <ul class="book-category">
                          <li class="book-category-badge">Adventure</li>
              ...
              <div class="shop-box-items style-3 wow fadeInUp" data-wow-delay=".6s">
                  <div class="book-thumb center">
                        <a href="shop-details"><img src="{{ asset('img/book/09.png') }}" alt="img"></a>
                  </div>
                  <div class="shop-content">
                      <ul class="book-category">
                          <li class="book-category-badge">Adventure</li>
